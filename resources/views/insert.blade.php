    ...
    <div class="container">
        ...
        <form action="/insert" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-5" style="color:gray;">
                ...
                <div class="col-sm-10">
                    <input name="price" type="value" class="form-control @error('price') is-invalid @enderror"
                        id="price">
                    @error('price')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="row mb-5" style="color:gray;">
                ...
                <div class="col-sm-10">
                    <input name="stock" type="value" class="form-control @error('stock') is-invalid @enderror" id="stock">
                    @error('stock')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
